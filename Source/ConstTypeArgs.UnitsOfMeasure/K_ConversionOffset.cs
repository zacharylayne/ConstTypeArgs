...
/// <summary>
/// The <see cref="K_ConversionOffset{T}"/> interface allows const type arguments that provide
/// a conversion offset to convert a value in one unit to the same value in another unit.
/// </summary>
/// <typeparam name="T">
/// The type of the value.
/// </typeparam>
public interface K_ConversionOffset<T> : K_Conversion<T>
    where T : struct, INumber<T>;

/// <summary>
/// The <see cref="K_ConversionOffset{T, TSelf}"/> interface allows const type arguments that provide
/// a conversion offset to convert a value in one unit to the same value in another unit.
/// </summary>
/// <typeparam name="T">
/// The type of the value.
...
/// The type itself.
/// </typeparam>
public interface K_ConversionOffset<T, TSelf> : K_ConversionOffset<T>
    where T : struct, INumber<T>
    where TSelf : K_ConversionOffset<T, TSelf>
{
    /// <summary>
