...
/// <summary>
/// The <see cref="K_ConversionExponential{T}"/> interface allows const type arguments that provide
/// an exponential conversion.
/// </summary>
/// <typeparam name="T">
/// The type of the value.
/// </typeparam>
public interface K_ConversionExponential<T> : K_Conversion<T>
    where T : struct, INumber<T>, IPowerFunctions<T>, IExponentialFunctions<T>, ILogarithmicFunctions<T>;

/// <summary>
/// The <see cref="K_ConversionExponential{T, TSelf}"/> interface allows const type arguments that provide
/// an exponential conversion.
/// </summary>
/// <typeparam name="T">
/// The type of the value.
...
/// The type itself.
/// </typeparam>
public interface K_ConversionExponential<T, TSelf> : K_ConversionExponential<T>
    where T : struct, INumber<T>, IPowerFunctions<T>, IExponentialFunctions<T>, ILogarithmicFunctions<T>
    where TSelf : K_ConversionExponential<T, TSelf>
{
    /// <summary>
