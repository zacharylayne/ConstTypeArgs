...
namespace ConstTypeArgs.Delegates.Interlocked.Or;
...
/// Interlocked.Or(ref ulong, ulong)</see> which is an atomic operation that performs a bitwise OR operation on the value of the first parameter
/// with the second and returns the original value.
/// </summary>
/// <exception cref="NullReferenceException">
/// Thrown when calling the method <see cref="Value"/> provides and the address of the first argument
